...
•	Khởi đầu: Khách hàng bắt đầu quá trình mua hàng
•	Lựa chọn sản phẩm: Xem danh sách, chọn sản phẩm & biến thể (màu, kích thước)
•	Giỏ hàng: Quyết định mua thêm hay thanh toán
•	Thông tin giao hàng: Nhập địa chỉ và chọn phương thức thanh toán
•	Thanh toán: VNPay hoặc MoMo
•	Xử lý kho: Nếu thành công, đơn hàng chuyển trạng thái Draft → Confirmed → gửi kho
•	Hoàn thành: Nhân viên kho chuẩn bị, khách hàng nhận hàng
